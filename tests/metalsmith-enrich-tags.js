...
describe('Metalsmith enrich tags', function () {
    ...
    beforeEach(function () {
        ...
        metadata = {
            tagsList: {
                'tag1': {'tag': 'tag1', 'path': 'tags/tag1.md'},
                'notEnriched': {'tag': 'notEnriched', 'path': 'tags/notEnriched.md'},
            },
        };
    });
    ...
    it('should add data to the tag page object', function () {
        enrichTags()(files, metalsmith, function () {
            assert.equal(3, Object.keys(metadata.tagsList.tag1).length);
    ...
    it('should keep intact tag page object without additional data', function () {
        enrichTags()(files, metalsmith, function () {
            assert.equal(2, Object.keys(metadata.tagsList.notEnriched).length);
